...
$unread   = $notifClass->getUnreadCount((int)$user['id']);
?>
<header class="topbar">
  ...
  <div class="topbar-actions">
    ...
    <div style="position:relative">
      <div class="user-pill" onclick="toggleUserMenu()">
        ...
        <div><span class="user-pill-name"><?= htmlspecialchars($user['name']) ?></span><span class="user-pill-role">Student</span></div>
